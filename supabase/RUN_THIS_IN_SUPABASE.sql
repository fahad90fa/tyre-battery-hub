...
-- Included: daily closings table, merchant payments column,
-- expenses date fix + backfill, pending-invoice auto-repair,
-- transaction date backfill (ledger/stock/payments).
-- ============================================================
