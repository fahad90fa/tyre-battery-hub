      ...
      <div className="hidden lg:flex flex-col justify-between p-12 bg-sidebar text-sidebar-foreground">
        <Link to="/" className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[11px] text-gold">Muzaffar Tyre And Battery House</div>
          </div>
        </Link>
        <div>
          <h1 className="text-4xl font-black leading-tight">
            Reliable power<br /> for every vehicle
          </h1>
          <p className="mt-4 text-white/70 max-w-sm">
            Sign in to track your orders, view invoices and manage your account.
          </p>
        </div>
        <div className="text-xs text-white/40">© MT&B HOUSE</div>
      </div>
